...
! function(e) {
    ...
    t = {
        ...
        dataURI2Blob: function(e) {
            var i, a, n, r, o, l, s = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder,
                d = t.hasBlobSupport(),
            ...
            return o = e.split(",")[0].split(":")[1].split(";")[0], d ? new Blob([t.hasArrayBufferViewSupport() ? n : a], {
                type: o
            }) : (l = new s, l.append(a), l.getBlob(o))
        },
        arrayBuffer2String: function(e) {
            if (window.TextDecoder) return new TextDecoder("utf-8").decode(e);
            var t, i, a, n, r = Array.prototype.slice.apply(new Uint8Array(e)),
                o = "",
                l = 0;
        ...
        _initPreviewCache: function() {
            ...
            i.previewCache = {
                ...
                get: function(a, n) {
                    ...
                    return v ? (n = void 0 === n ? !0 : n, l = t.ifSet("type", m, i.initialPreviewFileType || "generic"), d = t.ifSet("filename", m, t.ifSet("caption", m)), c = t.ifSet("filetype", m, l), s = i.previewCache.footer(a, n, m && m.size || null), p = t.ifSet("frameClass", m), r = h ? w(l, v, d, c, g, s, u, p) : w("generic", v, d, c, g, s, u, p, l).setTokens({
                        content: f.content[a]
                    }), f.tags.length && f.tags[a] && (r = t.replaceTags(r, f.tags[a])), t.isEmpty(m) || t.isEmpty(m.frameAttr) || (o = e(document.createElement("div")).html(r), o.find(".file-preview-initial").attr(m.frameAttr), r = o.html(), o.remove()), r) : ""
                },
        ...
        _parseFileType: function(e, i) {
            ...
            for (o = 0; o < s.length; o++)
                if (r = s[o], a = l.fileTypeSettings[r], n = a(e, i) ? r : "", !t.isEmpty(n)) return n;
            return "other"
        },
        ...
        _setZoomContent: function(i, a) {
            var n, r, o, l, s, d, c, p, u, f, m = this,
                v = i.attr("id"),
                g = m.$modal,
                h = g.find(".btn-prev"),
                w = g.find(".btn-next"),
        ...
        _uploadSingle: function(i, a) {
            var n, r, o, l, s, d, c, p, u, f, m, v = this,
        ...
        _setInitThumbAttr: function() {
            ...
            if (0 !== l)
                for (var s = 0; l > s; s++) e = o.config[s], n = r.previewInitId + "-init_" + s, i = t.ifSet("caption", e, t.ifSet("filename", e)), a = t.ifSet("size", e), r._setThumbAttr(n, i, a)
        },
        ...
        _readFiles: function(i) {
            ...
            n.loadedImages = [], n.totalImagesCount = 0, e.each(i, function(e, t) {
                ...
                var T, E, S, F, k, I, P, A, D, z, $, U, j = v + x,
                    B = u + "-" + j,
                    R = i[x],
                    O = m.text,
                    L = m.image,
                ...
                if (h > 0)
                    for (E = 0; h > E; E++) I = g[E], P = n.msgFileTypes[I] || I, q += 0 === E ? P : ", " + P;
                ...
                if (!t.isEmpty(g) && t.isArray(g)) {
                    ...
                    if (0 === W) return S = n.msgInvalidFileType.setTokens({
                        name: Z,
                        types: q
                    }), void y(S, R, B, x)
                }
        ...
        _validateAllImages: function() {
            ...
            if (r === a.totalImagesCount && (a._raise("fileimagesloaded"), a.resizeImage))
                for (e = 0; e < a.loadedImages.length; e++) t = a.loadedImages[e], t.validated || (i = t.siz, i && i > 1e3 * o && a._getResizedImage(t, n, r), a.loadedImages[e].validated = !0)
        },
        _getResizedImage: function(i, a, n) {
            var r, o, l, s, d, c, p, u = this,
                f = e(i.img)[0],
                m = f.naturalWidth,
                v = f.naturalHeight,
                g = 1,
        ...
        _setCaption: function(i, a) {
            var n, r, o, l, s, d = this,
                c = d.getFileStack();
            if (d.$caption.length) {
                if (d.$captionContainer.removeClass("icon-visible"), a) n = e("<div>" + d.msgValidationError + "</div>").text(), l = c.length, s = l ? 1 === l && c[0] ? d._getFileNames()[0] : d._getMsgSelected(l) : d._getMsgSelected(d.msgNo), r = t.isEmpty(i) ? s : i, o = '<span class="' + d.msgValidationErrorClass + '">' + d.msgValidationErrorIcon + "</span>";
                else {
